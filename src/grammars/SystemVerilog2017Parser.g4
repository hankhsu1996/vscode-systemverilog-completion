...
udp_declaration:
 KW_EXTERN ( udp_nonansi_declaration
  ...
  | ( ( udp_nonansi_declaration udp_port_declaration
      ...
      | udp_ansi_declaration
      ) udp_body KW_ENDPRIMITIVE ( COLON identifier | {this._input.LA(1) != SystemVerilog2017Parser.COLON}? )
;
...
action_block:
   ...
   | statement_or_null ( KW_ELSE statement_or_null | {this._input.LA(1) != SystemVerilog2017Parser.KW_ELSE}? )
;
seq_block:
    KW_BEGIN ( COLON identifier | {this._input.LA(1) != SystemVerilog2017Parser.COLON}? )
        ( block_item_declaration )* ( statement_or_null )*
    KW_END (COLON identifier |  {this._input.LA(1) != SystemVerilog2017Parser.COLON}?);
par_block:
    KW_FORK ( COLON identifier | {this._input.LA(1) != SystemVerilog2017Parser.COLON}? )
        ( block_item_declaration )* ( statement_or_null )*
    join_keyword ( COLON identifier |  {this._input.LA(1) != SystemVerilog2017Parser.COLON}? );
/******************************************** case ********************************************************************/
case_statement:
    ( unique_priority )?
...
conditional_statement:
    ...
    ( KW_ELSE statement_or_null | {this._input.LA(1) != SystemVerilog2017Parser.KW_ELSE}? );
subroutine_call_statement:
...
rs_if_else:
    ...
    ( KW_ELSE production_item | {this._input.LA(1) != SystemVerilog2017Parser.KW_ELSE}? );
rs_repeat:
...
constraint_expression:
    ...
    ( KW_ELSE constraint_set | {this._input.LA(1) != SystemVerilog2017Parser.KW_ELSE}? )
...
module_declaration:
  KW_EXTERN module_header_common ( list_of_port_declarations )? SEMI
   | module_header_common (list_of_port_declarations | (LPAREN DOT MUL RPAREN) )? SEMI
     ...
     KW_ENDMODULE ( COLON identifier | {this._input.LA(1) != SystemVerilog2017Parser.COLON}? )
;
module_keyword:
  KW_MODULE
   | KW_MACROMODULE
...
function_declaration:
    ...
    KW_ENDFUNCTION ( COLON identifier | {this._input.LA(1) != SystemVerilog2017Parser.COLON}? )
;
...
task_declaration:
    KW_TASK ( lifetime )?
	task_and_function_declaration_common
    KW_ENDTASK ( COLON identifier | {this._input.LA(1) != SystemVerilog2017Parser.COLON}? )
;
method_prototype:
    task_prototype
    | function_prototype
...
checker_declaration:
    ...
    KW_ENDCHECKER ( COLON identifier | {this._input.LA(1) != SystemVerilog2017Parser.COLON}? );
class_declaration:
    ...
    ( class_item )*
    KW_ENDCLASS ( COLON identifier | {this._input.LA(1) != SystemVerilog2017Parser.COLON}? );
always_construct:
...
package_declaration:
 ...
 ( ( attribute_instance )* package_item )*
  KW_ENDPACKAGE ( COLON identifier | {this._input.LA(1) != SystemVerilog2017Parser.COLON}?)
;
package_item:
 net_declaration
  | data_declaration
...
program_declaration:
 KW_EXTERN program_header
  | ( ( program_header
      ...
      ) KW_ENDPROGRAM ( COLON identifier | {this._input.LA(1) != SystemVerilog2017Parser.COLON}? )
;
program_header:
...
if_generate_construct:
    ...
    ( KW_ELSE generate_item | {this._input.LA(1) != SystemVerilog2017Parser.KW_ELSE}? );
case_generate_construct:
...
generate_begin_end_block:
    ( identifier COLON )? KW_BEGIN ( COLON identifier | {this._input.LA(1) != SystemVerilog2017Parser.COLON}? )
        ( generate_item )*
    KW_END ( COLON identifier | {this._input.LA(1) != SystemVerilog2017Parser.COLON}? )
;
generate_item:
